...
import com.dousiyo.meatwo310.util.KnockbackExplosion;
...
public class ImpulseGrenade extends ThrowableItemProjectile {
    ...
    public ImpulseGrenade(double x, double y, double z, Level level) {
        super(ModEntities.IMPULSE_GRENADE.get(), x, y, z, level);
    }

    public ImpulseGrenade(LivingEntity shooter, Level level) {
        super(ModEntities.IMPULSE_GRENADE.get(), shooter, level);
    }
    ...
    protected @NotNull Item getDefaultItem() {
        return ModItems.IMPULSE_GRENADE.get();
    }
}
