...
public class IceGrenadeItem extends Item {
    ...
    public IceGrenadeItem(Properties pProperties, int cooldownTicks) {
        super(pProperties);
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (!pLevel.isClientSide) {
            var grenade = new IceGrenade(pPlayer, pLevel);
    ...
    public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.meatwo310.ice_grenade").withStyle(ChatFormatting.GRAY));
